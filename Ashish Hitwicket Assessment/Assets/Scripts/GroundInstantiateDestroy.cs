...
public class GroundInstantiateDestroy : MonoBehaviour
{
    ...
    */
    ...
    private void Start()
    {
        spawntime = JsonReaderReal.instance.myrootjsonobjects.pulpit_data.pulpit_spawn_time - 1;
    ...
    private void Update()
    {
        if(currentgroundplane.timer <= spawntime)
        {
            ...
            {
                case 0:
                    newGroundPosition = new Vector3(currentgroundplane.transform.position.x + 9.2f, currentgroundplane.transform.position.y, currentgroundplane.transform.position.z);
                    break;
                ...
                case 2:
                    newGroundPosition = new Vector3(currentgroundplane.transform.position.x , currentgroundplane.transform.position.y, currentgroundplane.transform.position.z + 9.2f);
                    break;
